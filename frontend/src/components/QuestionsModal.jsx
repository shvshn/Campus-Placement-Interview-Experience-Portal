  ...
  return (
    <div className="questions-modal-overlay" onClick={onClose}>
      <div className="questions-modal-content" onClick={(e) => e.stopPropagation()}>
        <button className="questions-modal-close" onClick={onClose} aria-label="Close">
        ...
        <div className="questions-modal-header">
          ...
          <p>Browse all interview questions with their difficulty levels</p>
        </div>
        
        {/* Search Filters */}
        <div className="questions-search-filters">
          <div className="search-filter-group">
            <label htmlFor="modal-search-company">Company</label>
            <select
              id="modal-search-company"
              value={searchCompany}
          ...
          <div className="search-filter-group">
            <label htmlFor="modal-search-role">Role</label>
            <select
              id="modal-search-role"
              value={searchRole}
